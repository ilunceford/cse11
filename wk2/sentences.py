...
def main():
    ...
    for _ in range(6):
        sentence = make_sentence(random.choice([1, 2]), random.choice(["past", "present", "future"]))
        print(sentence)
...
def get_prepositional_phrase(quantity):
    ...
    # Construct and return the prepositional phrase.
...
def make_sentence(quantity, tense):
    ...
    # Construct and return the sentence with prepositional phrases.
